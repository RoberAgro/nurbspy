...
# Create an empry NURBS curve object
empty_nurbs = NurbsCurve()
...
N_basis = empty_nurbs.compute_basis_polynomials(n, p, U, u)
dN_basis = empty_nurbs.compute_basis_polynomials_derivatives(n, p, U, u, derivative_order=1)
ddN_basis = empty_nurbs.compute_basis_polynomials_derivatives(n, p, U, u, derivative_order=2)
...
a = -1/2*empty_nurbs.compute_basis_polynomials(n, p, U, u - h)
b = +1/2*empty_nurbs.compute_basis_polynomials(n, p, U, u + h)
dN_fd = (a+b)/h
...
a = +1*empty_nurbs.compute_basis_polynomials(n, p, U, u - h)
b = -2*empty_nurbs.compute_basis_polynomials(n, p, U, u)
c = +1*empty_nurbs.compute_basis_polynomials(n, p, U, u + h)
ddN_fd = (a+b+c)/h**2
