...
nurbs1 = NurbsCurve(control_points=P, weights=W, degree=p, knots=U)
...
# Create the B-Spline curve
nurbs2 = NurbsCurve(control_points=P, weights=W, degree=p, knots=U)
...
# Create the B-Spline curve
nurbs3 = NurbsCurve(control_points=P, weights=W, degree=p, knots=U)
